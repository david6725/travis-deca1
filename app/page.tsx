...
export default function Component() {
  ...
  return (
    ...
    >
      ...
      {/* Main Content */}
      <main className="flex flex-col items-center justify-center min-h-[calc(100vh-80px)] px-6 text-center relative z-10">
        <h1
        ...
        <div className="max-w-4xl mb-12">
          <p className={`text-xl md:text-2xl mb-4 font-semibold ${isDarkMode ? "text-gray-300" : "text-slate-700"}`}>
            Prepare. Practice. Perform.
          </p>
          <p className={`text-lg md:text-xl ${isDarkMode ? "text-gray-400" : "text-slate-600"}`}>
            Everything you need to succeed in DECA—right here at Travis.
          </p>
        </div>
        ...
        <div className="flex items-center justify-center gap-6 mt-8">
          {/* Instagram */}
          <button className="w-12 h-12 rounded-full transition-all duration-300 hover:scale-110 hover:shadow-lg flex items-center justify-center">
            <Image
